...
def persona_card(image_url, name, role, description,
                 ...
                 session_role, first_name, target_page, user_id=None):
...
with row1_col1:
    persona_card(
        image_url="https://api.dicebear.com/9.x/avataaars/svg?backgroundColor=transparent&accessories[]&accessoriesColor[]&clothing=blazerAndShirt,blazerAndSweater,collarAndSweater,overall,shirtCrewNeck,shirtScoopNeck,shirtVNeck&clothingGraphic[]&eyebrows=default,defaultNatural,flatNatural&eyes=default&facialHair=beardLight,beardMedium,moustacheFancy,moustacheMagnum,beardMajestic&facialHairColor=2c1b18,4a312c,724133&hairColor=2c1b18,4a312c,724133,a55728,b58143,c93305&mouth=default,serious,smile,twinkle&seed=Amaya",
        name="Adam Johnson",
        role="System Admin",
        description=(
...
with row2_col2:
    persona_card(
        image_url="https://api.dicebear.com/9.x/avataaars/svg?backgroundColor=transparent&accessories[]&accessoriesColor[]&clothing=blazerAndShirt,blazerAndSweater,collarAndSweater,overall,shirtCrewNeck,shirtScoopNeck,shirtVNeck&clothingGraphic[]&eyebrows=default,defaultNatural,flatNatural&eyes=default&facialHair=beardLight,beardMedium,moustacheFancy,moustacheMagnum,beardMajestic&facialHairColor=2c1b18,4a312c,724133&hairColor=2c1b18,4a312c,724133,a55728,b58143,c93305&mouth=default,serious,smile,twinkle&seed=Liliana",
        name="Johanna Park",
        role="Data Analyst",
        description=(
